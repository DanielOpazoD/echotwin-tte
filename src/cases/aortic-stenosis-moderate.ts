...
export const aorticStenosisModerateCase: CaseDefinitionInput = {
  ...
  seed: 505,
  history: 'Paciente sintética de 70 años con soplo sistólico y disnea leve de esfuerzo. Sin datos reales de paciente.',
  demographics: { ageYears: 70, sexForReference: 'female', heightCm: 160, weightKg: 68 },
  bodyHabitus: { chestWallThicknessCm: 2.4, chestWidthCm: 32, chestDepthCm: 21, ribSpacingCm: 2.5, intercostalWidthCm: 1.5 },
  rhythm: { type: 'sinus', heartRateBpm: 72, rrVariabilityPct: 2, pvcProbability: 0 },
  anatomy: {
    ...normalExcellentCase.anatomy,
    lv: { eddCm: 4.5, lengthEdCm: 8.0, ivsdCm: 1.1, lvpwdCm: 1.0, sphericity: 0.5, apexWallThicknessCm: 0.7 },
    ...
    aorticValve: { maxOpeningFraction: 0.5, calcification: 0.55, cuspThicknessCm: 0.18, bicuspid: false },
    tricuspid: { annulusDiameterCm: 3.05 },
  },
  physiology: { ...normalExcellentCase.physiology, edvMl: 104, esvMl: 36, mapseCm: 1.2, ePeakMps: 0.7, aPeakMps: 0.8, decelerationTimeMs: 225, ivrtMs: 95, ePrimeSeptalCmps: 6, ePrimeLateralCmps: 8 },
  hemodynamics: { systolicBpMmHg: 140, diastolicBpMmHg: 80, rapMmHg: 3, paspMmHg: 30, avEffectiveAreaCm2: 1.1, trPresent: true, lvotPeakGradientMmHg: 0, regurgitation: {} },
  flowPrimitives: normalExcellentCase.flowPrimitives.map((f) => (f.site === 'aortic-valve' ? { ...f, turbulence: 0.3 } : f)),
  learningObjectives: [
  ...
  difficulty: 2,
  references: [{ referenceId: 'ase-eacvi-aortic-stenosis-2017', usage: 'criterios de severidad moderada y ecuación de continuidad' }],
  impressionTruth: [
  ...
  expectedDeviations: ['ivsd', 'lvpwd', 'lv-mass'],
};
