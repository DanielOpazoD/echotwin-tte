...
export const pericardialEffusionTamponadeCase: CaseDefinitionInput = {
  ...
  seed: 1010,
  history: 'Paciente sintético de 48 años, disnea aguda, taquicardia e hipotensión tras pericarditis. Sin datos reales de paciente.',
  ...
  physiology: { ...normalExcellentCase.physiology, edvMl: 88, esvMl: 38, mapseCm: 1.2, tapseCm: 1.8, ePeakMps: 0.75, aPeakMps: 0.5, decelerationTimeMs: 170, ivrtMs: 70 },
  hemodynamics: { systolicBpMmHg: 92, diastolicBpMmHg: 65, rapMmHg: 16, paspMmHg: 34, avEffectiveAreaCm2: 3.0, trPresent: true, lvotPeakGradientMmHg: 0, regurgitation: {} },
  learningObjectives: [
