...
export const hocmSamCase: CaseDefinitionInput = {
  ...
  seed: 707,
  history:
    'Paciente sintético de 45 años con síncope de esfuerzo y soplo que aumenta con Valsalva. Sin datos reales de paciente.',
  ...
  flowPrimitives: [
    ...normalExcellentCase.flowPrimitives.map((f) =>
      f.site === 'lvot' ? { ...f, turbulence: 0.3 } : f,
    ),
