...
export const pulmonaryHypertensionRvCase: CaseDefinitionInput = {
  ...
  seed: 909,
  history: 'Paciente sintética de 61 años con disnea progresiva, edema de miembros inferiores y segundo ruido reforzado. Sin datos reales de paciente.',
  demographics: { ageYears: 61, sexForReference: 'female', heightCm: 163, weightKg: 70 },
  bodyHabitus: { chestWallThicknessCm: 2.3, chestWidthCm: 32, chestDepthCm: 21, ribSpacingCm: 2.5, intercostalWidthCm: 1.5 },
  rhythm: { type: 'sinus', heartRateBpm: 84, rrVariabilityPct: 2, pvcProbability: 0 },
  anatomy: {
    ...normalExcellentCase.anatomy,
    lv: { eddCm: 4.0, lengthEdCm: 8.0, ivsdCm: 0.85, lvpwdCm: 0.78, sphericity: 0.45, apexWallThicknessCm: 0.6 },
  ...
  flowPrimitives: normalExcellentCase.flowPrimitives.map((f) => (f.site === 'tr-jet' ? { ...f, turbulence: 0.35 } : f)),
  learningObjectives: [
  ...
  difficulty: 3,
  references: [{ referenceId: 'ase-right-heart-2025', usage: 'dimensiones y función del VD; estimación de la PSVD' }],
  impressionTruth: [
  ...
  expectedDeviations: ['lv-idd', 'rv-edv', 'rv-edvi', 'rv-basal', 'rv-mid', 'rv-lv-basal-ratio', 'rv-wall', 'rv-plax', 'ravi', 'ra-transverse', 'tv-annulus', 'tv-mv-ratio'],
};
