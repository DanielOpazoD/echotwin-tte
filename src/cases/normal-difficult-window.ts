...
export const normalDifficultWindowCase: CaseDefinitionInput = {
  ...
  anatomy: {
    ...
    lv: { eddCm: 4.5, lengthEdCm: 8.0, ivsdCm: 0.8, lvpwdCm: 0.8, sphericity: 0.5, apexWallThicknessCm: 0.6 },
  ...
  physiology: { ...normalExcellentCase.physiology, edvMl: 96, esvMl: 36, mapseCm: 1.3, tapseCm: 2.1 },
