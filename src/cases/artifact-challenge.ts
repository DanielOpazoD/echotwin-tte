...
export const artifactChallengeCase: CaseDefinitionInput = {
  ...
  seed: 1212,
  history: 'Paciente sintético de 79 años, EPOC y calcificación valvular; estudio de difícil interpretación. Sin datos reales de paciente.',
  demographics: { ageYears: 79, sexForReference: 'male', heightCm: 168, weightKg: 80 },
  bodyHabitus: { chestWallThicknessCm: 3.0, chestWidthCm: 34, chestDepthCm: 24, ribSpacingCm: 2.4, intercostalWidthCm: 1.2 },
  rhythm: { type: 'sinus', heartRateBpm: 76, rrVariabilityPct: 3, pvcProbability: 0.03 },
  anatomy: {
    ...normalExcellentCase.anatomy,
    lv: { eddCm: 4.7, lengthEdCm: 8.4, ivsdCm: 1.1, lvpwdCm: 1.0, sphericity: 0.5, apexWallThicknessCm: 0.7 },
    ...
    aorticValve: { maxOpeningFraction: 0.6, calcification: 0.7, cuspThicknessCm: 0.2, bicuspid: false },
  },
  physiology: { ...normalExcellentCase.physiology, edvMl: 115, esvMl: 46, mapseCm: 1.2, ePeakMps: 0.75, aPeakMps: 0.85, decelerationTimeMs: 230, ivrtMs: 100, ePrimeSeptalCmps: 5.5, ePrimeLateralCmps: 7.5 },
  hemodynamics: { systolicBpMmHg: 142, diastolicBpMmHg: 78, rapMmHg: 3, paspMmHg: 34, avEffectiveAreaCm2: 1.4, trPresent: true, lvotPeakGradientMmHg: 0, regurgitation: { mr: { eroaCm2: 0.1, jetDirectionDeg: 0 } } },
  acousticWindow: { chestWallAttenuation: 0.45, lungOverlapCm: 0.9, clutterLevel: 0.6, obesityAttenuation: 0.35, emphysemaScatter: 0.35, cardiacRotationDeg: 5 },
  artifacts: [
  ...
  difficulty: 5,
  references: [{ referenceId: 'ase-tte-2019', usage: 'optimización de imagen y reconocimiento de artefactos' }],
  impressionTruth: [
