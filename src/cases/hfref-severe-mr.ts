...
export const hfrefSevereMrCase: CaseDefinitionInput = {
  ...
  expectedDeviations: ['lv-edv', 'lv-esv', 'lv-ef', 'lv-edvi', 'lv-idd', 'lv-ids', 'lv-shortening', 'ivs-thickening', 'rv-edv', 'rv-edvi', 'la-ap', 'la-transverse', 'lavi', 'la-emptying', 'ra-transverse', 'la-ao', 'mv-annulus'],
};
