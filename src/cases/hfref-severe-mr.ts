...
export const hfrefSevereMrCase: CaseDefinitionInput = {
  ...
  seed: 303,
  history:
    'Paciente sintético de 66 años con miocardiopatía dilatada, disnea NYHA III y ortopnea. Sin datos reales de paciente.',
  ...
  acousticWindow: {
    chestWallAttenuation: 0.3,
    lungOverlapCm: 0.4,
    clutterLevel: 0.3,
    obesityAttenuation: 0.25,
    emphysemaScatter: 0.1,
    cardiacRotationDeg: 0,
  },
  flowPrimitives: [
    ...normalExcellentCase.flowPrimitives,
    { id: 'mr', site: 'mr-jet', enabled: true, turbulence: 0.35 },
  ],
  learningObjectives: [
  ...
  references: [
    {
      ...
      usage: 'volúmenes y FEVI por Simpson; dilatación del VI y la AI',
    },
  ...
  expectedDeviations: [
    ...
    'apex-thickness',
    'rv-edvi',
    // the RV of this case is enlarged and hypokinetic (TAPSE 1.6 cm and S′ 9 cm/s, both below normal): 192 mL and 44 %
    // once the outflow tract contracts less than the body (decision 214); 190 mL and 46 % before, at the edge of normal
    'rv-edv',
    'rv-ef',
    'la-ap',
    'la-transverse',
