...
describe('NIfTI-1 reader', () => {
  it('reads dims, spacing and uint8 voxels in column-major order', () => {
    ...
    const vol = parseNifti(
      buildNifti({ dims: [2, 3, 1], spacing: [0.31, 0.28, 1], datatype: 2, values, le: true }),
    );
