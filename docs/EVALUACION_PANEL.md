...
| 12 | El modo examen deja visible el score de la mejor vista en el HUD de la imagen y el corazón translúcido con el eje del VI en el torso | Educación | Alta | `ImageHud.tsx` sin condición de modo (antes `TopBar.tsx`); `TorsoView.tsx` añade siempre el corazón | El examen no mide reconocimiento ni orientación | Ocultar score y corazón en examen; opción de torso opaco en los demás modos |
