...
| Zoom / inversión lateral | 1…2,5×; booleano | Conversión de barrido, no adquisición | Es **display zoom**, no zoom acústico ni HR-ROI. Opera en vivo/cine. Nuevos calipers y contornos guardan calibración y se reproyectan, incluyendo zoom entre clics (decisión 120); los legados sin calibración no pueden reconstruirse. |
...
| Distancias, velocidades, tiempos, VTI manual, Simpson monoplano, TAPSE | cm, m/s o cm/s, ms, cm, mL | Geometría/píxeles de imagen o tira calibrados | No devuelven sin más la verdad del caso. La calibración espacial y conservación tras zoom de dibujos de sector están implementadas (decisión 120). Faltan identidad de cuadro/latido, manejo de costura de barrido y precisión ligada al muestreo |
