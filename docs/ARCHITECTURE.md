...
| Renderer                | `src/simulator/renderer`           | descriptor de modalidades (`modality.ts`, decisión 127), interfaz `RendererBackend`, trazador procedimental, atlas, consola, scan conversion, frame rate                       | anatomy, probe                                                                |
