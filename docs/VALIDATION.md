...
| Imagen apical del caso de ventana óptima frente a CAMUS Good (A4C y A2C, telediástole y telesístole): doce métricas de gris, contraste, textura y forma de la escala de grises dentro del rango intercuartílico; 28 de 48 declaradas como desviaciones del modelo, cada una con su valor basal y una tolerancia de 0,15 anchuras intercuartílicas (decisiones 88 y 90) | `clinicalImage.test.ts` | pasa |
