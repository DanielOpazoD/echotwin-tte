...
| Imagen apical del caso de ventana óptima frente a CAMUS Good (A4C y A2C, telediástole y telesístole): doce métricas de gris, contraste, textura y forma de la escala de grises, medias de 8 realizaciones del speckle con 4 realizaciones del ruido cada una, dentro del rango intercuartílico o a menos de 0,1 anchuras de él; 23 de 48 declaradas como desviaciones del modelo, cada una con su valor basal y una tolerancia de 0,15 anchuras intercuartílicas (decisiones 88, 90, 91 y 99) | `clinicalImage.test.ts` | pasa |
...
| Speckle del cuadro fuera del plano: con el corazón desplazado a lo largo de la normal del A4C, correlación de la envolvente del miocardio interior ≥ 0,97 a 0,2 mm y ≤ 0,8 a 3,2 mm (antes 0,76 a 0,2 mm) (decisión 99) | `elevationSpeckle.test.ts` | pasa |
